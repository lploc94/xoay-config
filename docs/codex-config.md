...
Use these options when you need more control over providers, policies, and integrations. For a quick start, see [Config basics](%5Bhttps://developers.openai.com/codex/config-basic%5D(https://developers.openai.com/codex/config-basic)).

For background on project guidance, reusable capabilities, custom slash commands, multi-agent workflows, and integrations, see [Customization](%5Bhttps://developers.openai.com/codex/concepts/customization%5D(https://developers.openai.com/codex/concepts/customization)). For configuration keys, see [Configuration Reference](%5Bhttps://developers.openai.com/codex/config-reference%5D(https://developers.openai.com/codex/config-reference)).
...
codex --config sandbox_workspace_[write.network](http://write.network)_access=true
...
For authentication details (including credential storage modes), see [Authentication](%5Bhttps://developers.openai.com/codex/auth%5D(https://developers.openai.com/codex/auth)). For the full list of configuration keys, see [Configuration Reference](%5Bhttps://developers.openai.com/codex/config-reference%5D(https://developers.openai.com/codex/config-reference)).

For shared defaults, rules, and skills checked into repos or system paths, see [Team Config](%5Bhttps://developers.openai.com/codex/enterprise/admin-setup#team-config%5D(https://developers.openai.com/codex/enterprise/admin-setup#team-config)).
...
For multi-agent role configuration `[agents]` in `config.toml`), see [Multi-agents](%5Bhttps://developers.openai.com/codex/multi-agent%5D(https://developers.openai.com/codex/multi-agent)).
...
base_url = "[http://proxy.example.com](http://proxy.example.com)"
...
[model_[providers.azure](http://providers.azure)]

name = "Azure"

base_url = "[https://YOUR_PROJECT_NAME.openai.azure.com/openai](https://YOUR_PROJECT_NAME.openai.azure.com/openai)"
...
Projects created with [data residency](%5Bhttps://help.openai.com/en/articles/9903489-data-residency-and-inference-residency-for-chatgpt%5D(https://help.openai.com/en/articles/9903489-data-residency-and-inference-residency-for-chatgpt)) enabled can create a model provider to update the base_url with the [correct prefix](%5Bhttps://platform.openai.com/docs/guides/your-data#which-models-and-features-are-eligible-for-data-residency%5D(https://platform.openai.com/docs/guides/your-data#which-models-and-features-are-eligible-for-data-residency)).
...
base_url = "[https://us.api.openai.com/v1](https://us.api.openai.com/v1)" # Replace 'us' with domain prefix
...
For operational details that are easy to miss while editing `config.toml`, see [Common sandbox and approval combinations](%5Bhttps://developers.openai.com/codex/security#common-sandbox-and-approval-combinations%5D(https://developers.openai.com/codex/security#common-sandbox-and-approval-combinations)), [Protected paths in writable roots](%5Bhttps://developers.openai.com/codex/security#protected-paths-in-writable-roots%5D(https://developers.openai.com/codex/security#protected-paths-in-writable-roots)), and [Network access](%5Bhttps://developers.openai.com/codex/security#network-access%5D(https://developers.openai.com/codex/security#network-access)).
...
Need the complete key list (including profile-scoped overrides and requirements constraints)? See [Configuration Reference](%5Bhttps://developers.openai.com/codex/config-reference%5D(https://developers.openai.com/codex/config-reference)) and [Managed configuration](%5Bhttps://developers.openai.com/codex/security#managed-configuration%5D(https://developers.openai.com/codex/security#managed-configuration)).
...
See the dedicated [MCP documentation](%5Bhttps://developers.openai.com/codex/mcp%5D(https://developers.openai.com/codex/mcp)) for configuration details.
...
exporter = { otlp-http = {
  ...
  endpoint = "[https://otel.example.com/v1/logs](https://otel.example.com/v1/logs)",
...
exporter = { otlp-grpc = {
  ...
  endpoint = "[https://otel.example.com:4317](https://otel.example.com:4317)",
...
For more security and privacy guidance around telemetry, see [Security](%5Bhttps://developers.openai.com/codex/security#monitoring-and-telemetry%5D(https://developers.openai.com/codex/security#monitoring-and-telemetry)).
...
notify = ["python3", "/path/to/[notify.py](http://notify.py)"]
...
See [Configuration Reference](%5Bhttps://developers.openai.com/codex/config-reference%5D(https://developers.openai.com/codex/config-reference)) for the exact keys.
...
For a detailed walkthrough, see [Custom instructions with ](%5Bhttps://developers.openai.com/codex/guides/agents-md%5D(https://developers.openai.com/codex/guides/agents-md))[AGENTS.md](http://AGENTS.md).
...
See [Configuration Reference](%5Bhttps://developers.openai.com/codex/config-reference%5D(https://developers.openai.com/codex/config-reference)) for the full key list.